      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-0 md:inset-auto md:bottom-20 md:right-4 md:w-[380px] md:h-[580px] 
              bg-secondary md:rounded-2xl shadow-2xl flex flex-col overflow-hidden z-[9999] border-t md:border-t-0 border-white/10"
          >
            {/* HEADER */}
